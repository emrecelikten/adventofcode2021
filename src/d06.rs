...
fn simulate_growth(fishes: &[u8], days: usize) -> usize {
    let mut cur_fishes = fishes.to_vec();
    for _ in 0..days {
        step(&mut cur_fishes)
    }
...
fn simulate_growth_large(fishes: &[u8], days: usize) -> usize {
...
mod tests {
    ...
    const TEST_DATA: &str = r"3,4,3,1,2";
